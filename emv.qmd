...
[amostra observada](populacao-e-amostra.qmd#sec-ao) e portanto: $\hat\theta_{n} = \hat\theta_(x_{1},x_{2},\dots,x_{n})$.

O [estimador](estimadores.qmd) de máxima verossimilhança é obtido substituindo $(x_{1},\dots,x_{n})$ por 
$(X_{1},\dots,X_{n})$, ou seja, $\hat\theta_{(X_{1},\dots,X_{n})}$ é o Estimador de Máxima Verossimilhança (EMV)
