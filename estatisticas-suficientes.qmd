...
f_{\theta_2}^{\boldsymbol{X}_n} &= \frac{\mathrm{exp}\left\{-\frac{1}{2\cdot 9}(\sum X_i^2 - 2\cdot 3 \cdot \sum X_i +4n)\right\}}{(\sqrt{2\pi\cdot9})^n}.
\end{aligned}
$$
Portanto,
<!-- TODO: achar um jeito de pular linha -->
$$
\begin{aligned}
T'(\boldsymbol{X}_n) &= \left(
...
\frac{\frac{\mathrm{exp}\left\{-\frac{1}{2}(\sum X_i^2 - 2 \sum X_i +n)\right\}}{(\sqrt{2\pi})^n}}
{\frac{\mathrm{exp}\left\{-\frac{1}{2\cdot 9}(\sum X_i^2 - 2\cdot 3 \cdot \sum X_i +4n)\right\}}{(\sqrt{2\pi\cdot9})^n}}
\right) \\
&=\left(
\frac{\mathrm{exp}\left\{-\frac{1}{2}\left(
\frac{1}{4} \sum X_i^2 - \sum X_i^2 - 2(\frac{2}{4} \sum X_i - \sum X_i)
\right)
\right\}}{4^{\frac{n}{2}}}, \\ % o \\ deveria estar funcionando
\frac{\mathrm{exp}\left\{-\frac{1}{2}\left(
