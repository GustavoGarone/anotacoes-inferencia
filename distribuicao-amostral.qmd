...
Seja $(Y_1,\dots,Y_n)$ uma [amostra aleatória](populacao-e-amostra.qmd#sec-aa) de $Y\sim f_\theta, \theta \in \Theta$.
...
podemos encontrar a distribuição de [estatísticas](estatisticas.qmd) e
[estimadores](estimadores.qmd).
:::
