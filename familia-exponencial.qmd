...
pode-se mostrar que a sua função densidade de probabilidade não pertence à
FE **unidimensional**.
...
Refaça o exemplo 5 do caso univariado com $N(\theta, \theta^2)$ e mostre que pertence à FE de dimensão 2.
