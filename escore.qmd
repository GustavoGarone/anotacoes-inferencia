...
### Teorema (das condições do escore)
...
&= \int_{\mathfrak{X}} \frac{\partial}{\partial}\ln f_\theta(x) \cdot f_\theta(x) dx \\
&= \int_{\mathfrak{X}} \frac{\partial}{\partial} f_\theta(x) dx, \forall \theta \in \Theta
\end{aligned}
$$
...
= \int_{\mathfrak{X}} \frac{\partial}{\partial \theta} f_\theta(x) dx
$$
