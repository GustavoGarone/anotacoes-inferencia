...
Para as duas últimas condições, substituímos no caso discreto as integrais
por somatórios.
...
Nem toda condição de regularidade é necessária para provar algum teorema. Em
muitos casos, por exemplo, podemos utilizar
