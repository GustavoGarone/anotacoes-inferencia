...
$$
P_\theta(h(T(\boldsymbol{X}_n))=0) = 1, \forall \theta \in \Theta\; \text{ou simplesmente}\ \mathrm{q.c.}
$$
...
\stackrel{\rho = \frac{\theta}{1-\theta} \in (0,\infty)}{\iff}&\sum h(k) \binom{n}{k} \rho^k = 0, \forall \theta \in \Theta = (0,1).
\end{aligned}
$$
...
Portanto, $T(\mathbb{X}_n)$ é completa para o modelo.
