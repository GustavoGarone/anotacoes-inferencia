...
Veja: [Modelo Estatístico](modelo-estatistico.qmd) para definições dos
modelos estatísticos paramétricos.

## Variável Populacional {#sec-vp}

Pela teoria estatística, população é o conjunto sob investigação de todos
os potenciais elementos.

A *Variável Populacional* representa os valores numéricos de cada elemento da
população:
$$
...
Na estatística descritiva, a amostra é definida como um subconjunto da
população.

Alguns livros utilizam o termo "amostra representativa" para representar a
amostra
confiável de outra amostra que carrega determinados viéses de seleção. O
termo
