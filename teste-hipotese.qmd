...
a face voltada para cima após o lançamento é cara. Dessa forma, sendo $X$ o resultado de um lançamento, teremos a
...
Seja $(\pmb{X}_{n})$ amostra aleatória de $X\sim N(\mu,\sigma^2)$ em que $\sigma^2$ é conhecido.
...
em que $\theta = \mu \in \mathbb{R}$. Portanto,
$$
\alpha_{\max} = \sup_{\theta \in \Theta_{0}} \pi(\theta)
$$

Como $H_{0}:\mu=\mu_{0} \Leftrightarrow H_{0}: \theta \in \Theta_0$, em que $\Theta_{0}=\{ \mu_{0} \}$, 
$\sup_{\theta \in \Theta_{0}} \pi(\theta)$ ocorre quando $\theta = \mu_0$
Portanto, temos que
$$
...
P_{\mu_{0}}\left(\frac{\bar{X}-\mu_{0}}{\sqrt{ \frac{\sigma^2}{n} }} < -1.96 \right) = 2.5\%$
...
Seja $(\pmb{X}_{n})$ amostra aleatória de $X\sim \mathrm{N}(\mu,\sigma^2)$ com $\sigma^2 = 5, n = 10$ Com as hipóteses
$$
\begin{cases}
H_{0} : \mu = 10 \\
H_{1}: \mu \neq 10
...
1. Definimos o Modelo Estatístico:
	1. “Seja $(\pmb{X}_{n})$ amostra aleatória de $x \sim f_{\theta}, \theta \in \Theta$”
...
### Exemplo um
Seja $(\pmb{X}_{n})$ a.a de $X\sim \mathrm{N}(\mu,\sigma^2)$ em que $\sigma^2$ é conhecido.
...
### Exemplo 3
Seja $(\pmb{X}_{n})$ amostra aleatória de $X \sim \mathrm{N}(\mu,\sigma^2)$ em que
...
### Exemplo 4
Seja $(\pmb{X}_{n})$ amostra aleatória de $X\sim N(\mu,\sigma^2)$ em que $X$ é o peso do pacote de café. Colheu-se uma amostra
...
Seja $(\pmb{X}_{n})$ amostra aleatória de $X\sim \mathrm{N}(\mu,\sigma^2)$ em que $\sigma^2$ é conhecido.
$$
\begin{aligned}
&1.
\begin{cases}
...
Seja $(\pnmb{X}_{n})$ amostra aleatória de $X \sim \mathrm{N}(\mu,\sigma^2)$ em que $\theta = (\mu, \sigma^2) \in \Theta = \mathrm{R}
...
Seja $(\pmb{X}_{n})$ amostra aleatória de $X \sim \mathrm{N}(\mu,\sigma^2)$ em que
$\theta = (\mu, \sigma^2) \in \Theta = \mathrm{R} \times \mathrm{R}^+$, ou seja, ambos parâmetros são desconhecidos.
$$
\begin{cases}
H_{0} : \sigma^2 = \sigma^2_{0} \\
H_{1}: \sigma^2 \neq \sigma^2_{0}
