...
Podemos usar
$$
s^2_{D}(\boldsymbol{D})=\frac{1}{n-1}\sum^n_{i=1}(D_{i}-\bar{D}_{\mathrm{Par}})^2
$$
...
Temos que $s^2(\boldsymbol{D})=0.9$. (Podemos calcular diretamente ou usando a coluna $D^2$ e substituindo no
...
Primeiro calculamos $n'= 32.08 \stackrel{\text{Arredonda}}{=}32$. Assim, $t_{32,0.025} = 2.037$.
