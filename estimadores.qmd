...
Seja $(X_{1},\dots,X_{n})$ a.a. de $X\sim f_{\theta,}\theta \in \Theta$ e considere $T(X_{1},\dots,X_{n})=\hat\theta$
um estimador para $\theta$.
Dizemos que $\hat \theta$ é *não-enviesado* para $\theta$ $\Leftrightarrow$
$$
...
#### Estimadores não viciados assintoticamente
