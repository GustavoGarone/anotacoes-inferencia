...
```{julia}
#| echo: true
using Distributions, Statistics, Random, Printf
Random.seed!(123)
...
def simula_montecarlo(theta0, M, n, corrigido=False):
    ...
    # No NumPy, o parâmetro global  'ddof' (Delta Degrees of Freedom) 
    # controla o denominador para var() e sd(). ddof=1 divide por n-1, ddof=0 divide por n.
