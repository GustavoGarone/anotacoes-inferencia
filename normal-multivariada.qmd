...
$$
\begin{aligned}
f^{\boldsymbol{X}}(\boldsymbol{x}) &= \frac{1}{(2\pi)^{\frac{d}{2}} \left(\prod
...
-\frac{1}{2}\underbracket{\sum^n(\boldsymbol{x}_i - \boldsymbol{\mu})^T
...
$$
\begin{cases}
A = \sum^n (\boldsymbol{\mu} - \bar{\boldsymbol{x}})^T \Sigma^{-1}
(\boldsymbol{x}_i - \bar{\boldsymbol{x}}) =
(\boldsymbol{\mu} - \bar{\boldsymbol{x}})^T \Sigma^{-1} (\sum^n \boldsymbol{x}_i
- \bar{\boldsymbol{x}}) = 0 \\
B = \sum^n (\boldsymbol{x}_i - \bar{\boldsymbol{x}})^T \Sigma^{-1}
(\boldsymbol{\mu} - \bar{\boldsymbol{x}}) =
(\sum^n \boldsymbol{x}_i - \bar{\boldsymbol{x}})^T \Sigma^{-1} (\boldsymbol{\mu}
- \bar{\boldsymbol{x}}) = 0
\end{cases}
$$
